...
export const JULIA_STDLIBS = new Set([
  'LinearAlgebra', 'Random', 'Statistics', 'SparseArrays', 'Printf', 'TOML', 'Dates',
  'Test', 'Pkg', 'Serialization', 'SHA', 'Logging', 'Markdown', 'UUIDs',
  'Distributed', 'InteractiveUtils', 'Base64', 'Unicode', 'REPL',
])
...
export function checkImports(
  roots: string[],
  allow: { allowlist: string[]; support_set: string[] },
): CheckResult {
