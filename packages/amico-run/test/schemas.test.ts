...
const goodManifest = {
  schema_version: "1",
  run_id: "r20260610-101245Z-ab12",
  script_path: "/s.jl",
  lab: "default",
  lab_id: "default",
  created_at: "2026-06-10T10:12:45Z",
  orchestrator_version: "0.1.0",
  julia: { binary: "julia" },
};

describe("validateManifest", () => {
  it("accepts a conforming manifest", () => expect(validateManifest(goodManifest)).toEqual({ ok: true, errors: [] }));
...
describe("schemas.ts is delegation-only (no re-introduced schema)", () => {
  ...
  it("imports the shared @amicode/schema", () => expect(src).toMatch(/from ["']@amicode\/schema["']/));
