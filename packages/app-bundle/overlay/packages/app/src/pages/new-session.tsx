(globalThis as Record<string, unknown>).__amicodeNewSessionBust = "1457" // #1457 cache-bust: rotate the lazy chunk hash — the webview HTTP cache held a poisoned entry for the old URL
