export const dict = {
  ...
  "command.review.toggle": "Side Panel",
  ...
  "agent.picker.default": "default",
  "posture.indicator.label": "Posture",
  "posture.mode.plan": "plan",
  "posture.mode.develop": "develop",
  "posture.mode.research": "research",
  "posture.mode.build": "build",
  "posture.current": "current: {{mode}}",
  "posture.offer.recommend": "Plan ready — this looks like {{mode}} work",
  "posture.offer.ambiguous": "Plan ready — it could go either way; pick a posture",
  "posture.offer.switch": "Switch to {{mode}}",
  "posture.offer.wrong": "Wrong — actually {{mode}}",
  "posture.offer.stay": "Stay in plan",
  "posture.offer.dismiss": "Dismiss",
  "posture.walkback": "Return to plan",
  "posture.switched.announce": "Switched to {{mode}} — the next prompt carries the new posture",
  "posture.switched.deferred": "Will switch to {{mode}} when the current turn finishes",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Amicode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Amicode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Amicode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Amicode.",
  ...
  "prompt.example.1": "Optimize an X gate on my transmon",
  "prompt.example.2": "Walk me through designing a pulse",
  "prompt.example.3": "Show me my latest run's fidelity",
  "prompt.example.4": "Warm-start from my last pulse",
  "prompt.example.5": "What can Amicode do?",
  ...
  "dialog.server.description": "Switch which Amicode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Amicode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Amicode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Amicode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Amicode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Amicode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Amicode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Amicode",
  "wsl.onboarding.opencodeReadyIn": "Amicode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Amicode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Amicode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Amicode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Amicode.",
  ...
  "toast.update.description": "A new version of Amicode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Amicode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Amicode does not support MCP authentication yet.',
  ...
  "status.popover.tab.connections": "Connections",
  "dialog.connections.empty": "No connections available",
  "dialog.connections.retry": "Retry",
  "dialog.connections.fetchFailed": "Could not reach the server for connection status",
  "dialog.connections.state.connected": "Connected",
  "dialog.connections.state.needsKey": "Not connected — enter a key to connect",
  "dialog.connections.state.invalid": "Key rejected — check it and try again",
  "dialog.connections.state.expired": "Token expired — reconnect to mint a fresh one",
  "dialog.connections.state.unreachable": "Service unreachable — check the URL or try again",
  "dialog.connections.state.unentitled": "Project not authorized — check the project ID",
  "dialog.connections.state.validating": "Validating key…",
  "dialog.connections.state.unknown": "Status needs attention",
  "dialog.connections.baseUrlPlaceholder": "Service URL",
  "dialog.connections.tokenPlaceholder": "API key",
  "dialog.connections.usernamePlaceholder": "Username",
  "dialog.connections.passwordPlaceholder": "Password",
  "dialog.connections.projectIdPlaceholder": "Project ID",
  "dialog.connections.submit": "Connect",
  "dialog.connections.disconnect": "Disconnect",
  "dialog.connections.revalidate": "Revalidate",
  ...
  "dialog.connections.drift":
    "This key answered as {{answered}}, was {{stored}} — historical runs may stop authorizing",
  "dialog.connections.state.waitingBrowser": "Waiting for your browser — finish signing in there",
  "dialog.connections.state.waitingCode": "Waiting for the code — enter it on any device",
  "dialog.connections.state.chooseProject": "Signed in — pick the project runs should bill to",
  "dialog.connections.method.credentials": "Password",
  "dialog.connections.method.browser": "Browser",
  "dialog.connections.method.deviceCode": "Device code",
  "dialog.connections.method.token": "Token",
  ...
  "amicode.editInChat": "Edit in session",
  "amicode.contextTree.title": "Context tree",
  "amicode.contextTree.count": "{{count}} in context",
  "amicode.contextTree.fit": "Fit tree to view",
  ...
  "amicode.vault.back": "Back to files",
  "amicode.vault.empty": "No vaults attached yet",
  "amicode.vault.error": "Could not read this vault",
  "amicode.vault.unreadable": "This file can't be previewed here",
  "amicode.vault.truncated": "Listing truncated — the vault is larger than the panel shows",
  "amicode.vault.noServer": "No server to ask — connect a server first",
  "amicode.vault.retry": "Retry",
  "amicode.vault.fetchError": "Could not load the vault — check the server and retry",
  "amicode.vault.attach": "Attach a vault",
  "amicode.vault.attachHint": "No vaults mounted — attach one from Connections (the status menu, top right)",
  "amicode.zoomIn": "Zoom in",
  "amicode.zoomOut": "Zoom out",
  "amicode.zoomReset": "Reset zoom",
  ...
  "sidebar.gettingStarted.line1": "Amicode includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Sessions",
  ...
  "app.name.desktop": "Amicode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Amicode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Amicode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Amicode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Amicode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Amicode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Amicode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Amicode.",
  ...
  "settings.skills.description": "Manage skill providers — directories containing custom skills that extend Amico's capabilities.",
  "settings.skills.section.providers": "Skill Providers",
  "settings.skills.provider.type.directory": "Directory",
  "settings.skills.provider.type.url": "URL",
  "settings.skills.provider.type.workspace": "Workspace",
  "settings.skills.provider.type.shipped": "Platform",
  "settings.skills.action.add_directory": "Add directory",
  "settings.skills.action.remove": "Remove",
  "settings.skills.empty": "No custom skill providers configured. Add a directory containing skills to get started.",
  "settings.subagents.title": "Subagent model routing",
  "settings.subagents.description": "Which model each subagent role dispatches on. Suggestions derive from your live providers and stay display-only until you opt in; without any configuration dispatch uses this session's model.",
  "settings.subagents.opt_in": "Use suggested routing",
  "settings.subagents.opt_in_hint": "Suggestions apply at dispatch. Without it they are display-only.",
  "settings.subagents.providers": "Live providers: {{providers}}",
  "settings.subagents.providers.unknown": "Live providers unknown — dispatch falls back to this session's model",
  "settings.subagents.column.role": "Role",
  "settings.subagents.column.model": "Model",
  "settings.subagents.provenance.user-set": "user-set",
  "settings.subagents.provenance.fleet-locked": "fleet-locked",
  "settings.subagents.provenance.tuned": "tuned",
  "settings.subagents.provenance.suggested": "suggested",
  "settings.subagents.provenance.default": "default",
  "settings.subagents.inherit": "this session's model",
  "settings.subagents.suggestion": "Suggested: {{model}}",
  "settings.subagents.edit": "Edit",
  "settings.subagents.save": "Save",
  "settings.subagents.cancel": "Cancel",
  "settings.subagents.reset": "Reset to tuned",
  "settings.subagents.drift": "Differs from the tuned default ({{model}})",
  "settings.subagents.empty": "No subagent roles found.",
  "settings.subagents.unavailable": "Routing settings are not available on this server.",
  "settings.subagents.model_hint": "\"provider/model\", or empty to reset",
