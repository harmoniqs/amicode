export const dict = {
  ...
  "prompt.example.1": "Run an experiment on my system",
  "prompt.example.2": "Walk me through setting up a new problem",
  "prompt.example.3": "Show me my latest run's result",
  "prompt.example.4": "Continue from my best previous result",
