...
export const dict = {
  ...
  "posture.current": "目前：{{mode}}",
  "posture.offer.recommend": "計畫就緒 — 這像是 {{mode}} 的工作",
  "posture.offer.ambiguous": "計畫就緒 — 兩者皆可；請選擇一種姿態",
  "posture.offer.switch": "切換到 {{mode}}",
  "posture.offer.wrong": "不對 — 其實是 {{mode}}",
  "posture.offer.stay": "留在計畫",
  "posture.offer.dismiss": "忽略",
  "posture.walkback": "返回計畫",
  "posture.switched.announce": "已切換到 {{mode}} — 下一條提示將採用新姿態",
  "posture.switched.deferred": "目前回合結束後將切換到 {{mode}}",
