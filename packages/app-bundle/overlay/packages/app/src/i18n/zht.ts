...
export const dict = {
  ...
  "desktop.wsl.error.updateVersion": "OpenCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  "desktop.wsl.error.noVersion": "無版本資訊",
  "desktop.wsl.error.serverExited": "WSL 伺服器在啟動後結束 (code={{code}} signal={{signal}})",
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL 伺服器在健全狀態確認前結束 (code={{code}} signal={{signal}}){{output}}",
  ...
  "help.tabs.sessions": "在分頁中開始新的工作階段，或從任一專案開啟現有的工作階段。開始新工作時請開啟新分頁，完成後再將其關閉。",
  "help.tabs.organize": "同時開啟幾個分頁，可讓進行中的工作階段更容易整理。如果打算保留分頁，請將其重新命名為容易記住的名稱。",
  "help.tabs.home": "你可以在新的首頁找到所有工作階段和專案。選取工作階段即可在分頁中開啟。",
  "help.tabs.persistence": "重新開啟應用程式時，分頁仍會保持開啟。",
  "help.tabs.worktrees": "新版設計尚未支援 Git Worktrees，此功能即將推出。如果你偏好繼續使用先前的版面，可以在設定中切換版面。請留意，新版面將在幾週後成為永久版面。",
