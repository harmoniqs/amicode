export const dict = {
  ...
  "posture.current": "현재: {{mode}}",
  "posture.offer.recommend": "플랜 완료 — {{mode}} 작업으로 보입니다",
  "posture.offer.ambiguous": "플랜 완료 — 어느 쪽일지 모호합니다; 포스처를 선택하세요",
  "posture.offer.switch": "{{mode}}(으)로 전환",
  "posture.offer.wrong": "아니요 — 사실은 {{mode}}",
  "posture.offer.stay": "플랜 유지",
  "posture.offer.dismiss": "닫기",
  "posture.walkback": "플랜으로 돌아가기",
  "posture.switched.announce": "{{mode}}(으)로 전환되었습니다 — 다음 프롬프트부터 새 포스처가 적용됩니다",
  "posture.switched.deferred": "현재 턴이 끝나면 {{mode}}(으)로 전환합니다",
