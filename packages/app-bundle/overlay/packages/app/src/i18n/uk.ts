export const dict = {
  ...
  "posture.current": "поточна: {{mode}}",
  "posture.offer.recommend": "План готовий — це схоже на роботу {{mode}}",
  "posture.offer.ambiguous": "План готовий — підходить в обидва боки; виберіть позу",
  "posture.offer.switch": "Перейти в {{mode}}",
  "posture.offer.wrong": "Неправильно — насправді {{mode}}",
  "posture.offer.stay": "Залишитися в плані",
  "posture.offer.dismiss": "Приховати",
  "posture.walkback": "Повернутися до плану",
  "posture.switched.announce": "Переключено на {{mode}} — наступний запит піде в новій позі",
  "posture.switched.deferred": "Переключиться на {{mode}}, коли поточний хід завершиться",
