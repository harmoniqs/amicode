...
export const dict = {
  ...
  "desktop.wsl.error.updateVersion": "Oppdateringen av OpenCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL-serveren ble avsluttet før den var klar (code={{code}} signal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Tidsavbrudd for tilstandskontrollen av sidecar for {{distro}} etter {{timeout}} ms",
  ...
  "terminal.connectTicket.csrfError": "Tilkoblingsbilletten for PTY ble avvist av opprinnelses- eller CSRF-kontroller. Kontroller serverens CORS-konfigurasjon.",
  ...
  "help.tabs.sessions": "Start en ny sesjon i en fane, eller åpne en eksisterende sesjon fra et av prosjektene dine. Åpne en ny fane når du skal begynne på noe nytt, og lukk den når du er ferdig.",
  "help.tabs.organize": "Når du har noen få faner åpne, blir det enklere å organisere de aktive sesjonene. Gi fanene navn som er lette å huske, hvis du planlegger å beholde dem.",
  "help.tabs.home": "Du finner alle sesjonene og prosjektene dine på den nye Hjem-skjermen. Når du velger en sesjon, åpnes den i en fane.",
  "help.tabs.persistence": "Fanene er fortsatt åpne når du åpner appen på nytt.",
  "help.tabs.worktrees": "Det nye oppsettet støtter ikke Git Worktrees ennå, men støtte kommer snart. Hvis du foretrekker å fortsette med det forrige oppsettet, kan du bytte mellom oppsettene i Innstillinger. Vær oppmerksom på at det nye oppsettet blir permanent om noen uker.",
