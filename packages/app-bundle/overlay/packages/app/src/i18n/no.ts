...
export const dict = {
  ...
  "posture.current": "nåværende: {{mode}}",
  "posture.offer.recommend": "Plan klar — dette ser ut som {{mode}}-arbeid",
  "posture.offer.ambiguous": "Plan klar — det kan gå begge veier; velg en postur",
  "posture.offer.switch": "Bytt til {{mode}}",
  "posture.offer.wrong": "Feil — faktisk {{mode}}",
  "posture.offer.stay": "Bli i planen",
  "posture.offer.dismiss": "Avvis",
  "posture.walkback": "Tilbake til planen",
  "posture.switched.announce": "Byttet til {{mode}} — neste prompt bærer den nye posturen",
  "posture.switched.deferred": "Bytter til {{mode}} når gjeldende tur er ferdig",
