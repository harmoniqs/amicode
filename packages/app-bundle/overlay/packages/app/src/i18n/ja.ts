export const dict = {
  ...
  "posture.current": "現在: {{mode}}",
  "posture.offer.recommend": "プラン完了 — {{mode}}の作業のようです",
  "posture.offer.ambiguous": "プラン完了 — どちらにも取れます。ポスチャを選んでください",
  "posture.offer.switch": "{{mode}} に切り替え",
  "posture.offer.wrong": "違います — 実際は {{mode}}",
  "posture.offer.stay": "プランのまま",
  "posture.offer.dismiss": "閉じる",
  "posture.walkback": "プランに戻る",
  "posture.switched.announce": "{{mode}} に切り替えました — 次のプロンプトから新しいポスチャで動きます",
  "posture.switched.deferred": "現在のターン完了後に {{mode}} へ切り替えます",
  ...
  "fleet.sessions.degraded": "ハブが遅くなっています — 低速状態",
  "fleet.sessions.provenance.hub": "ハブ",
  "fleet.sessions.provenance.local": "ローカル",
