...
export const dict = {
  ...
  "desktop.wsl.error.updateVersion": "OpenCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  "desktop.wsl.error.noVersion": "无版本信息",
  "desktop.wsl.error.serverExited": "WSL 服务器启动后退出（code={{code}} signal={{signal}}）",
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL 服务器在进入正常状态前退出（code={{code}} signal={{signal}}）{{output}}",
  ...
  "help.tabs.sessions": "在标签页中开始新会话，或从任意项目打开现有会话。开始处理新任务时打开新标签页，完成后将其关闭。",
  "help.tabs.organize": "保持打开几个标签页，可更轻松地整理进行中的会话。如果打算保留某个标签页，请为其指定一个便于记忆的名称。",
  "help.tabs.home": "你可以在新的主页中找到所有会话和项目。选择会话即可在标签页中将其打开。",
  "help.tabs.persistence": "重新打开应用时，标签页仍会保持打开。",
  "help.tabs.worktrees": "新设计暂不支持 Git Worktrees，此功能即将推出。如果希望继续使用之前的布局，可在“设置”中切换布局。请注意，新布局将在几周后永久启用。",
