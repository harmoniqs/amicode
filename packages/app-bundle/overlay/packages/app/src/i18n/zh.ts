...
export const dict = {
  ...
  "posture.current": "当前：{{mode}}",
  "posture.offer.recommend": "计划已就绪 — 这像是 {{mode}} 的工作",
  "posture.offer.ambiguous": "计划已就绪 — 两者皆可；请选择一种姿态",
  "posture.offer.switch": "切换到 {{mode}}",
  "posture.offer.wrong": "不对 — 其实是 {{mode}}",
  "posture.offer.stay": "留在计划",
  "posture.offer.dismiss": "忽略",
  "posture.walkback": "返回计划",
  "posture.switched.announce": "已切换到 {{mode}} — 下一条提示将采用新姿态",
  "posture.switched.deferred": "当前回合结束后将切换到 {{mode}}",
