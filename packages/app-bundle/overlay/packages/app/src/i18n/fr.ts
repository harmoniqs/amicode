export const dict = {
  ...
  "posture.current": "actuel : {{mode}}",
  "posture.offer.recommend": "Plan prêt — cela ressemble à un travail {{mode}}",
  "posture.offer.ambiguous": "Plan prêt — cela pourrait aller dans les deux sens ; choisissez une posture",
  "posture.offer.switch": "Passer à {{mode}}",
  "posture.offer.wrong": "Erreur — en fait {{mode}}",
  "posture.offer.stay": "Rester en plan",
  "posture.offer.dismiss": "Ignorer",
  "posture.walkback": "Revenir au plan",
  "posture.switched.announce": "Passé à {{mode}} — la prochaine requête portera la nouvelle posture",
  "posture.switched.deferred": "Basculera vers {{mode}} à la fin du tour en cours",
  ...
  "fleet.sessions.degraded": "Le hub est lent — dégradé",
