export const dict = {
  ...
  "desktop.recovery.unresponsive.detail": "Vous pouvez relancer l'application, ouvrir les journaux ou continuer d'attendre.",
  ...
  "desktop.wsl.error.updateVersion": "La mise à jour d'OpenCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "Le serveur WSL s'est arrêté avant d'être opérationnel (code={{code}} signal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "La vérification de l'état du processus auxiliaire pour {{distro}} a dépassé le délai de {{timeout}} ms",
  ...
  "help.tabs.toast.ariaLabel": "Présentation des onglets. Organisez votre travail et vos sessions actives à l'aide d'onglets",
  ...
  "help.tabs.sessions": "Démarrez une nouvelle session dans un onglet ou ouvrez une session existante depuis l'un de vos projets. Ouvrez un nouvel onglet lorsque vous commencez une nouvelle tâche et fermez-le une fois celle-ci terminée.",
  "help.tabs.organize": "Garder quelques onglets ouverts facilite l'organisation de vos sessions actives. Si vous comptez les conserver, renommez-les pour pouvoir les reconnaître facilement.",
  "help.tabs.home": "Vous trouverez toutes vos sessions et tous vos projets sur le nouvel écran d'accueil. La sélection d'une session l'ouvre dans un onglet.",
  "help.tabs.persistence": "Lorsque vous rouvrez l'application, vos onglets sont toujours ouverts.",
  "help.tabs.worktrees": "La nouvelle interface ne prend pas encore en charge les arbres de travail Git, mais cette fonctionnalité sera bientôt disponible. Si vous préférez continuer à utiliser la mise en page précédente, vous pouvez changer de mise en page dans les paramètres. N'oubliez pas que la nouvelle mise en page deviendra définitive dans quelques semaines.",
  ...
  "terminal.connectTicket.csrfError": "Le ticket de connexion PTY a été rejeté par les contrôles d'origine ou CSRF. Vérifiez la configuration CORS du serveur.",
  ...
  // English fallback — Amicode key with no locale translation yet (#796).
