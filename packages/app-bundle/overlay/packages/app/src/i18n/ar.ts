export const dict = {
  ...
  "posture.current": "الحالية: {{mode}}",
  "posture.offer.recommend": "الخطة جاهزة — تبدو عمل {{mode}}",
  "posture.offer.ambiguous": "الخطة جاهزة — قد تصلح للاتجاهين؛ اختر وضعية",
  "posture.offer.switch": "التبديل إلى {{mode}}",
  "posture.offer.wrong": "خطأ — في الحقيقة {{mode}}",
  "posture.offer.stay": "البقاء في الخطة",
  "posture.offer.dismiss": "تجاهل",
  "posture.walkback": "العودة إلى الخطة",
  "posture.switched.announce": "تم التبديل إلى {{mode}} — الحث التالي سيحمل الوضعية الجديدة",
  "posture.switched.deferred": "سيتم التبديل إلى {{mode}} عند انتهاء الدور الحالي",
  ...
  "fleet.sessions.degraded": "المحور بطيء — متدهور",
  "fleet.sessions.provenance.hub": "المحور",
  "fleet.sessions.provenance.local": "محلي",
