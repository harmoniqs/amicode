...
export const dict = {
  ...
  "posture.current": "geçerli: {{mode}}",
  "posture.offer.recommend": "Plan hazır — bu {{mode}} işine benziyor",
  "posture.offer.ambiguous": "Plan hazır — iki yönde de olabilir; bir duruş seçin",
  "posture.offer.switch": "{{mode}} moduna geç",
  "posture.offer.wrong": "Yanlış — aslında {{mode}}",
  "posture.offer.stay": "Planda kal",
  "posture.offer.dismiss": "Kapat",
  "posture.walkback": "Plana dön",
  "posture.switched.announce": "{{mode}} moduna geçildi — bir sonraki istem yeni duruşu taşır",
  "posture.switched.deferred": "Geçerli tur bitince {{mode}} moduna geçecek",
