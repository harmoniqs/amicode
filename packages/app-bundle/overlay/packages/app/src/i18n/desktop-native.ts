...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.wsl.error.installOpencode": "Amicode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Amicode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Amicode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
