export const dict = {
  ...
  "posture.current": "ปัจจุบัน: {{mode}}",
  "posture.offer.recommend": "แผนพร้อมแล้ว — ดูเหมือนงาน {{mode}}",
  "posture.offer.ambiguous": "แผนพร้อมแล้ว — ไปทางไหนก็ได้; เลือกท่าทาง",
  "posture.offer.switch": "สลับไป {{mode}}",
  "posture.offer.wrong": "ไม่ใช่ — จริง ๆ คือ {{mode}}",
  "posture.offer.stay": "อยู่ในแผนต่อ",
  "posture.offer.dismiss": "ปิด",
  "posture.walkback": "กลับไปที่แผน",
  "posture.switched.announce": "สลับไป {{mode}} แล้ว — พรอมต์ถัดไปจะใช้ท่าทางใหม่",
  "posture.switched.deferred": "จะสลับไป {{mode}} เมื่อรอบปัจจุบันเสร็จ",
