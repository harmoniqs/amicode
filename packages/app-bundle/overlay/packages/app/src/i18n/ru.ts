export const dict = {
  ...
  "agent.picker.default": "по умолчанию",
  ...
  "posture.current": "текущая: {{mode}}",
  "posture.offer.recommend": "План готов — это похоже на работу {{mode}}",
  "posture.offer.ambiguous": "План готов — подходит в обе стороны; выберите позу",
  "posture.offer.switch": "Перейти в {{mode}}",
  "posture.offer.wrong": "Неверно — на самом деле {{mode}}",
  "posture.offer.stay": "Остаться в плане",
  "posture.offer.dismiss": "Скрыть",
  "posture.walkback": "Вернуться к плану",
  "posture.switched.announce": "Переключено на {{mode}} — следующий запрос пойдёт в новой позе",
  "posture.switched.deferred": "Переключится на {{mode}}, когда текущий ход завершится",
