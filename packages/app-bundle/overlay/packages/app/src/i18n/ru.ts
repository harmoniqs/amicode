export const dict = {
  ...
  "desktop.wsl.error.updateVersion": "Обновление OpenCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "Сервер WSL завершил работу до перехода в рабочее состояние (код={{code}}, сигнал={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Истекло время ожидания проверки работоспособности Sidecar для {{distro}} ({{timeout}} мс)",
  ...
  "help.tabs.sessions": "Начните новую сессию во вкладке или откройте существующую сессию из любого проекта. Открывайте новую вкладку, когда начинаете новую задачу, и закрывайте её по завершении.",
  "help.tabs.organize": "Несколько открытых вкладок упрощают организацию активных сессий. Если вы планируете оставить вкладки открытыми, присвойте им запоминающиеся названия.",
  "help.tabs.home": "Все сессии и проекты находятся на новом экране «Главная». При выборе сессии она открывается во вкладке.",
  "help.tabs.persistence": "После повторного открытия приложения вкладки останутся открытыми.",
  "help.tabs.worktrees": "Новый дизайн пока не поддерживает Git Worktrees, но эта возможность скоро появится. Если вы предпочитаете прежний макет, переключиться между макетами можно в разделе «Настройки». Учтите, что через несколько недель новый макет станет постоянным.",
  ...
  "terminal.connectTicket.csrfError": "Билет подключения PTY отклонён при проверке источника или CSRF. Проверьте конфигурацию CORS сервера.",
