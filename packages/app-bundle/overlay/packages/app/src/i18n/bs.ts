export const dict = {
  ...
  "posture.current": "trenutna: {{mode}}",
  "posture.offer.recommend": "Plan spreman — ovo liči na {{mode}} posao",
  "posture.offer.ambiguous": "Plan spreman — može u oba smjera; odaberite pozu",
  "posture.offer.switch": "Prebaci na {{mode}}",
  "posture.offer.wrong": "Pogrešno — zapravo {{mode}}",
  "posture.offer.stay": "Ostati u planu",
  "posture.offer.dismiss": "Odbaci",
  "posture.walkback": "Vratiti se na plan",
  "posture.switched.announce": "Prebačeno na {{mode}} — sljedeći prompt nosi novu pozu",
  "posture.switched.deferred": "Prebačit će na {{mode}} kada se trenutni završi",
