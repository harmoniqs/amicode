export const dict = {
  ...
  "posture.current": "nuværende: {{mode}}",
  "posture.offer.recommend": "Plan klar — dette ligner {{mode}}-arbejde",
  "posture.offer.ambiguous": "Plan klar — det kunne gå begge veje; vælg en postur",
  "posture.offer.switch": "Skift til {{mode}}",
  "posture.offer.wrong": "Forkert — faktisk {{mode}}",
  "posture.offer.stay": "Bliv i planen",
  "posture.offer.dismiss": "Afvis",
  "posture.walkback": "Tilbage til planen",
  "posture.switched.announce": "Skiftet til {{mode}} — næste prompt bærer den nye postur",
  "posture.switched.deferred": "Skifter til {{mode}}, når den aktuelle runde er færdig",
