export const dict = {
  ...
  "terminal.connectTicket.csrfError": "PTY-forbindelsesticket blev afvist ved kontrollen af oprindelse eller CSRF. Kontrollér serverens CORS-konfiguration.",
  ...
  "desktop.wsl.error.updateVersion": "Opdateringen af OpenCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL-serveren blev afsluttet, før den var klar (code={{code}} signal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Tilstandskontrollen af sidecar-processen for {{distro}} fik timeout efter {{timeout}} ms",
  ...
  "help.tabs.sessions": "Start en ny session i en fane, eller åbn en eksisterende session fra et af dine projekter. Åbn en ny fane, når du går i gang med noget nyt, og luk den, når du er færdig.",
  "help.tabs.organize": "Når du holder nogle få faner åbne, er det nemmere at organisere dine aktive sessioner. Giv fanerne navne, der er nemme at huske, hvis du vil beholde dem.",
  "help.tabs.home": "Du finder alle dine sessioner og projekter på den nye startskærm. Når du vælger en session, åbnes den i en fane.",
  "help.tabs.persistence": "Dine faner er stadig åbne, når du åbner appen igen.",
  "help.tabs.worktrees": "Det nye design understøtter endnu ikke Git Worktrees, men understøttelsen kommer snart. Hvis du foretrækker at fortsætte med det tidligere layout, kan du skifte mellem layoutene under Indstillinger. Bemærk, at det nye layout bliver permanent om nogle få uger.",
