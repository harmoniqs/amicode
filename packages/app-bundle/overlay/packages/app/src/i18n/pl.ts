export const dict = {
  ...
  "posture.current": "bieżąca: {{mode}}",
  "posture.offer.recommend": "Plan gotowy — to wygląda na pracę {{mode}}",
  "posture.offer.ambiguous": "Plan gotowy — może pójść w obie strony; wybierz posturę",
  "posture.offer.switch": "Przełącz na {{mode}}",
  "posture.offer.wrong": "Nie — w rzeczywistości {{mode}}",
  "posture.offer.stay": "Zostań w planie",
  "posture.offer.dismiss": "Odrzuć",
  "posture.walkback": "Wróć do planu",
  "posture.switched.announce": "Przełączono na {{mode}} — następny prompt poniesie nową posturę",
  "posture.switched.deferred": "Przełączy na {{mode}}, gdy bieżąca tura się zakończy",
