export const dict = {
  ...
  "desktop.recovery.unresponsive.detail": "Puedes volver a iniciar la aplicación, abrir los registros o seguir esperando.",
  ...
  "desktop.wsl.error.updateVersion": "La actualización de OpenCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "El servidor WSL se cerró antes de estar operativo (código={{code}} señal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Se agotó el tiempo de espera de la comprobación de estado del sidecar de {{distro}} tras {{timeout}} ms",
  ...
  "help.tabs.sessions": "Inicia una nueva sesión en una pestaña o abre una sesión existente de cualquiera de tus proyectos. Abre una pestaña nueva cuando empieces algo nuevo y ciérrala cuando termines.",
  "help.tabs.organize": "Mantener algunas pestañas abiertas facilita la organización de las sesiones activas. Cambia el nombre de las pestañas por uno fácil de recordar si piensas conservarlas.",
  "help.tabs.home": "Encontrarás todas tus sesiones y proyectos en la nueva pantalla Inicio. Al seleccionar una sesión, se abre en una pestaña.",
  "help.tabs.persistence": "Cuando vuelvas a abrir la aplicación, las pestañas seguirán abiertas.",
  "help.tabs.worktrees": "El nuevo diseño aún no admite Git Worktrees, pero estarán disponibles pronto. Si prefieres seguir usando el diseño anterior, puedes cambiar de diseño en Ajustes. Ten en cuenta que el nuevo diseño será permanente dentro de unas semanas.",
  ...
  "terminal.connectTicket.csrfError": "El ticket de conexión PTY fue rechazado por las comprobaciones de origen o CSRF. Comprueba la configuración CORS del servidor.",
