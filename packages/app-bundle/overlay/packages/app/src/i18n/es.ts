export const dict = {
  ...
  "agent.picker.default": "predeterminado",
  ...
  "posture.current": "actual: {{mode}}",
  "posture.offer.recommend": "Plan listo — esto parece trabajo de {{mode}}",
  "posture.offer.ambiguous": "Plan listo — podría ir en cualquier dirección; elige una postura",
  "posture.offer.switch": "Cambiar a {{mode}}",
  "posture.offer.wrong": "Error — en realidad {{mode}}",
  "posture.offer.stay": "Quedarse en el plan",
  "posture.offer.dismiss": "Descartar",
  "posture.walkback": "Volver al plan",
  "posture.switched.announce": "Cambiado a {{mode}} — el siguiente prompt llevará la nueva postura",
  "posture.switched.deferred": "Cambiará a {{mode}} cuando termine el turno actual",
