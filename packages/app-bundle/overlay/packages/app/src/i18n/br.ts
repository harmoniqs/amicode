export const dict = {
  ...
  "agent.picker.default": "padrão",
  "posture.indicator.label": "Postura",
  "posture.mode.plan": "plan",
  "posture.mode.develop": "develop",
  "posture.mode.research": "research",
  "posture.mode.build": "build",
  "posture.current": "atual: {{mode}}",
  "posture.offer.recommend": "Plano pronto — parece trabalho de {{mode}}",
  "posture.offer.ambiguous": "Plano pronto — pode seguir nos dois caminhos; escolha uma postura",
  "posture.offer.switch": "Mudar para {{mode}}",
  "posture.offer.wrong": "Errado — na verdade {{mode}}",
  "posture.offer.stay": "Ficar no plano",
  "posture.offer.dismiss": "Descartar",
  "posture.walkback": "Voltar ao plano",
  "posture.switched.announce": "Mudado para {{mode}} — o próximo prompt terá a nova postura",
  "posture.switched.deferred": "Mudará para {{mode}} quando o turno atual terminar",
  ...
  "fleet.sessions.degraded": "O hub está lento — degradado",
  ...
  "amicode.contextTree.canvasLabel": "The agent's context tree — turns branch from amico. Click a file node to open it; arrow keys walk the nodes and Enter opens the focused one",
  ...
  "settings.general.row.dataStorage.database.description": "Override the path to the opencode session database. Leave empty to use the default location.",
  ...
  "settings.general.row.dataStorage.configDir.description": "Override the opencode configuration directory. Leave empty to use the default location.",
