export const dict = {
  ...
  "command.panel.reset": "Rezeriñ stad ar panell",
  ...
  "desktop.wsl.error.updateVersion": "A atualização do OpenCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  "desktop.wsl.error.noVersion": "sem versão",
  "desktop.wsl.error.serverExited": "O servidor WSL foi encerrado após a inicialização (código={{code}} sinal={{signal}})",
  "desktop.wsl.error.serverExitedBeforeHealthy": "O servidor WSL foi encerrado antes de ficar íntegro (código={{code}} sinal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "O tempo limite da verificação de integridade do sidecar de {{distro}} foi excedido após {{timeout}}ms",
  ...
  "help.tabs.sessions": "Inicie uma nova sessão em uma aba ou abra uma sessão existente de qualquer um dos seus projetos. Abra uma nova aba quando começar algo novo e feche-a quando terminar.",
  "help.tabs.organize": "Manter algumas abas abertas facilita a organização das sessões ativas. Renomeie as abas com nomes fáceis de lembrar se pretende mantê-las abertas.",
  "help.tabs.home": "Você encontrará todas as suas sessões e projetos na nova tela Início. Ao selecionar uma sessão, ela será aberta em uma aba.",
  "help.tabs.persistence": "Quando você reabrir o aplicativo, suas abas ainda estarão abertas.",
  "help.tabs.worktrees": "O novo design ainda não oferece suporte a Git Worktrees, mas esse recurso estará disponível em breve. Se preferir continuar usando o layout anterior, você poderá alternar entre os layouts nas Configurações. Lembre-se apenas de que o novo layout se tornará permanente em algumas semanas.",
  ...
  "terminal.connectTicket.csrfError": "O tíquete de conexão PTY foi rejeitado pelas verificações de origem ou CSRF. Verifique a configuração de CORS do servidor.",
