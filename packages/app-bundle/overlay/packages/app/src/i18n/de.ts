...
export const dict = {
  ...
  "posture.current": "aktuell: {{mode}}",
  "posture.offer.recommend": "Plan fertig — das sieht nach {{mode}}-Arbeit aus",
  "posture.offer.ambiguous": "Plan fertig — es könnte in beide Richtungen gehen; wähle eine Postur",
  "posture.offer.switch": "Zu {{mode}} wechseln",
  "posture.offer.wrong": "Falsch — eigentlich {{mode}}",
  "posture.offer.stay": "Im Plan bleiben",
  "posture.offer.dismiss": "Verwerfen",
  "posture.walkback": "Zurück zum Plan",
  "posture.switched.announce": "Zu {{mode}} gewechselt — der nächste Prompt trägt die neue Postur",
  "posture.switched.deferred": "Wechselt zu {{mode}}, wenn der aktuelle Zug abgeschlossen ist",
