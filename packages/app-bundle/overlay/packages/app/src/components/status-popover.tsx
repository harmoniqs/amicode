...
const Body = lazy(() => retryImport(() => import("./status-popover-body").then((x) => ({ default: x.StatusPopoverBody }))))
const ServerBody = lazy(() => retryImport(() => import("./status-popover-body").then((x) => ({ default: x.StatusPopoverServerBody }))))
const GlobalBody = lazy(() => retryImport(() => import("./status-popover-body").then((x) => ({ default: x.StatusPopoverGlobalBody }))))
