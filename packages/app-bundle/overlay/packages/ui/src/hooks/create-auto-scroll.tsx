...
export function createAutoScroll(options: AutoScrollOptions) {
  ...
  return {
    ...
    // amicode: clear the user-scrolled flag WITHOUT triggering a scroll —
    // lets callers decouple "re-engage auto-follow" from "scroll now",
    // so the virtualizer's own scrollToEnd() can handle positioning
    // without fighting this hook's instant scrollToBottom.
    clearUserScrolled: () => {
      if (store.userScrolled) setStore("userScrolled", false)
    },
