...
const VALID = {
  ...
  version: 1,
  derived_from: null,
  name: "Solve a graph problem",
  outcome: "An optimized waveform",
  audience: ["algorithms"],
  ...
  stages: [
    {
      id: "application",
      emits: ["circuit"],
      questions: [{ id: "graph", prompt: "Which graph?", choices: ["sample", "upload"], default: "sample" }],
    },
