...
//
// Behavior:
//   - copies packages/extension/agents/{autodev,autoresearch}.md to each
//     EXISTING destination directory (missing destination dirs are skipped,
//     not created);
...
const CARDS = ["autodev.md", "autoresearch.md"];
